...
function newSession(opts) {
  ...
  const ctx = {
    ...
    _aurixRemotePortfolioEpochMs: 0,              // epoch de reset del lado cuenta (estado de módulo en app.js)
    _aurixBackendSnapshotsTruncated: false,       // ¿la lectura paginada se quedó corta? (owner único en app.js)
