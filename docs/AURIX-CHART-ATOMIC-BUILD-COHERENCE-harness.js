...
ok('0 version.json.appjs = 575', versionJson.appjs === 575);
ok('0 index APPJS_V = 575', /var APPJS_V = '575';/.test(indexHtml));
ok('0 index requests app.js?v=575', /app\.js\?v=575/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 575', /__AURIX_APPJS_VERSION__ = '575';/.test(app));
