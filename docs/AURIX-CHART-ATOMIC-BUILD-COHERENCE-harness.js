...
ok('0 version.json.appjs = 528', versionJson.appjs === 528);
ok('0 index APPJS_V = 528', /var APPJS_V = '528';/.test(indexHtml));
ok('0 index requests app.js?v=528', /app\.js\?v=528/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 528', /__AURIX_APPJS_VERSION__ = '528';/.test(app));
