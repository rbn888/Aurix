...
ok('0 version.json.appjs = 560', versionJson.appjs === 560);
ok('0 index APPJS_V = 560', /var APPJS_V = '560';/.test(indexHtml));
ok('0 index requests app.js?v=560', /app\.js\?v=560/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 560', /__AURIX_APPJS_VERSION__ = '560';/.test(app));
