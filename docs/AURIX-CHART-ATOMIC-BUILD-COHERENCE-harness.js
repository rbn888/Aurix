...
ok('0 version.json.appjs = 546', versionJson.appjs === 546);
ok('0 index APPJS_V = 546', /var APPJS_V = '546';/.test(indexHtml));
ok('0 index requests app.js?v=546', /app\.js\?v=546/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 546', /__AURIX_APPJS_VERSION__ = '546';/.test(app));
