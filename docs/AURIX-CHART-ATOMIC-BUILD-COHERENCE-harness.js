...
ok('0 version.json.appjs = 603', versionJson.appjs === 603);
ok('0 index APPJS_V = 603', /var APPJS_V = '603';/.test(indexHtml));
ok('0 index requests app.js?v=603', /app\.js\?v=603/.test(indexHtml));
