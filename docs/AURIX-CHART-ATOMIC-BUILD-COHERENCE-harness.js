...
ok('0 version.json.appjs = 567', versionJson.appjs === 567);
ok('0 index APPJS_V = 567', /var APPJS_V = '567';/.test(indexHtml));
ok('0 index requests app.js?v=567', /app\.js\?v=567/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 567', /__AURIX_APPJS_VERSION__ = '567';/.test(app));
