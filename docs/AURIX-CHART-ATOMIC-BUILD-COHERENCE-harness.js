...
ok('0 version.json.appjs = 529', versionJson.appjs === 529);
ok('0 index APPJS_V = 529', /var APPJS_V = '529';/.test(indexHtml));
ok('0 index requests app.js?v=529', /app\.js\?v=529/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 529', /__AURIX_APPJS_VERSION__ = '529';/.test(app));
