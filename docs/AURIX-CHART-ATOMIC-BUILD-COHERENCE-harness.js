...
ok('0 version.json.appjs = 583', versionJson.appjs === 583);
ok('0 index APPJS_V = 583', /var APPJS_V = '583';/.test(indexHtml));
ok('0 index requests app.js?v=583', /app\.js\?v=583/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 583', /__AURIX_APPJS_VERSION__ = '583';/.test(app));
