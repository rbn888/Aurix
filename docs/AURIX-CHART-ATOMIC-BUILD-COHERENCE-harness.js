...
ok('0 version.json.appjs = 598', versionJson.appjs === 598);
ok('0 index APPJS_V = 598', /var APPJS_V = '598';/.test(indexHtml));
ok('0 index requests app.js?v=598', /app\.js\?v=598/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 598', /__AURIX_APPJS_VERSION__ = '598';/.test(app));
