...
ok('0 version.json.appjs = 584', versionJson.appjs === 584);
ok('0 index APPJS_V = 584', /var APPJS_V = '584';/.test(indexHtml));
ok('0 index requests app.js?v=584', /app\.js\?v=584/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 584', /__AURIX_APPJS_VERSION__ = '584';/.test(app));
