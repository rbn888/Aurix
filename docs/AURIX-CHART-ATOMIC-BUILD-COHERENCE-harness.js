...
ok('0 version.json.appjs = 571', versionJson.appjs === 571);
ok('0 index APPJS_V = 571', /var APPJS_V = '571';/.test(indexHtml));
ok('0 index requests app.js?v=571', /app\.js\?v=571/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 571', /__AURIX_APPJS_VERSION__ = '571';/.test(app));
