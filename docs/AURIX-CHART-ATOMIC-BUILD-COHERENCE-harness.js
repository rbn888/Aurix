...
ok('0 version.json.appjs = 558', versionJson.appjs === 558);
ok('0 index APPJS_V = 558', /var APPJS_V = '558';/.test(indexHtml));
ok('0 index requests app.js?v=558', /app\.js\?v=558/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 558', /__AURIX_APPJS_VERSION__ = '558';/.test(app));
