...
ok('0 version.json.appjs = 542', versionJson.appjs === 542);
ok('0 index APPJS_V = 542', /var APPJS_V = '542';/.test(indexHtml));
ok('0 index requests app.js?v=542', /app\.js\?v=542/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 542', /__AURIX_APPJS_VERSION__ = '542';/.test(app));
