...
ok('0 version.json.appjs = 578', versionJson.appjs === 578);
ok('0 index APPJS_V = 578', /var APPJS_V = '578';/.test(indexHtml));
ok('0 index requests app.js?v=578', /app\.js\?v=578/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 578', /__AURIX_APPJS_VERSION__ = '578';/.test(app));
