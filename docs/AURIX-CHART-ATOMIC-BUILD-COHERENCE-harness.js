...
ok('0 version.json.appjs = 531', versionJson.appjs === 531);
ok('0 index APPJS_V = 531', /var APPJS_V = '531';/.test(indexHtml));
ok('0 index requests app.js?v=531', /app\.js\?v=531/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 531', /__AURIX_APPJS_VERSION__ = '531';/.test(app));
