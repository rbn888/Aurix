...
ok('0 version.json.appjs = 593', versionJson.appjs === 593);
ok('0 index APPJS_V = 593', /var APPJS_V = '593';/.test(indexHtml));
ok('0 index requests app.js?v=593', /app\.js\?v=593/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 593', /__AURIX_APPJS_VERSION__ = '593';/.test(app));
