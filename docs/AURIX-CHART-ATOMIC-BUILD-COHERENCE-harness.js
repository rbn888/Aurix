...
ok('0 version.json.appjs = 585', versionJson.appjs === 585);
ok('0 index APPJS_V = 585', /var APPJS_V = '585';/.test(indexHtml));
ok('0 index requests app.js?v=585', /app\.js\?v=585/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 585', /__AURIX_APPJS_VERSION__ = '585';/.test(app));
