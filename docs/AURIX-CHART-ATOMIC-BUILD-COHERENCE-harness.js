...
ok('0 version.json.appjs = 554', versionJson.appjs === 554);
ok('0 index APPJS_V = 554', /var APPJS_V = '554';/.test(indexHtml));
ok('0 index requests app.js?v=554', /app\.js\?v=554/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 554', /__AURIX_APPJS_VERSION__ = '554';/.test(app));
