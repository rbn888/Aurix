...
ok('0 version.json.appjs = 527', versionJson.appjs === 527);
ok('0 index APPJS_V = 527', /var APPJS_V = '527';/.test(indexHtml));
ok('0 index requests app.js?v=527', /app\.js\?v=527/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 527', /__AURIX_APPJS_VERSION__ = '527';/.test(app));
