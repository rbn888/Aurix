...
ok('0 version.json.appjs = 553', versionJson.appjs === 553);
ok('0 index APPJS_V = 553', /var APPJS_V = '553';/.test(indexHtml));
ok('0 index requests app.js?v=553', /app\.js\?v=553/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 553', /__AURIX_APPJS_VERSION__ = '553';/.test(app));
