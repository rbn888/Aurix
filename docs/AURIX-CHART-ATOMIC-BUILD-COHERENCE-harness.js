...
ok('0 version.json.appjs = 556', versionJson.appjs === 556);
ok('0 index APPJS_V = 556', /var APPJS_V = '556';/.test(indexHtml));
ok('0 index requests app.js?v=556', /app\.js\?v=556/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 556', /__AURIX_APPJS_VERSION__ = '556';/.test(app));
