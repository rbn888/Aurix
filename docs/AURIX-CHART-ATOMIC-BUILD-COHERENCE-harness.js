...
ok('0 version.json.appjs = 532', versionJson.appjs === 532);
ok('0 index APPJS_V = 532', /var APPJS_V = '532';/.test(indexHtml));
ok('0 index requests app.js?v=532', /app\.js\?v=532/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 532', /__AURIX_APPJS_VERSION__ = '532';/.test(app));
