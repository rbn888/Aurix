...
ok('0 version.json.appjs = 568', versionJson.appjs === 568);
ok('0 index APPJS_V = 568', /var APPJS_V = '568';/.test(indexHtml));
ok('0 index requests app.js?v=568', /app\.js\?v=568/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 568', /__AURIX_APPJS_VERSION__ = '568';/.test(app));
