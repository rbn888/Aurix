...
ok('0 version.json.appjs = 545', versionJson.appjs === 545);
ok('0 index APPJS_V = 545', /var APPJS_V = '545';/.test(indexHtml));
ok('0 index requests app.js?v=545', /app\.js\?v=545/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 545', /__AURIX_APPJS_VERSION__ = '545';/.test(app));
