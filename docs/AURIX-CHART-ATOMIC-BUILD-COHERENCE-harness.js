...
ok('0 version.json.appjs = 564', versionJson.appjs === 564);
ok('0 index APPJS_V = 564', /var APPJS_V = '564';/.test(indexHtml));
ok('0 index requests app.js?v=564', /app\.js\?v=564/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 564', /__AURIX_APPJS_VERSION__ = '564';/.test(app));
