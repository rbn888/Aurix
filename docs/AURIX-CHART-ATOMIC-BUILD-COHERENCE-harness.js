...
ok('0 version.json.appjs = 591', versionJson.appjs === 591);
ok('0 index APPJS_V = 591', /var APPJS_V = '591';/.test(indexHtml));
ok('0 index requests app.js?v=591', /app\.js\?v=591/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 591', /__AURIX_APPJS_VERSION__ = '591';/.test(app));
