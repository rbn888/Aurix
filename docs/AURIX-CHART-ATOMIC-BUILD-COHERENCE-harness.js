...
ok('0 version.json.appjs = 590', versionJson.appjs === 590);
ok('0 index APPJS_V = 590', /var APPJS_V = '590';/.test(indexHtml));
ok('0 index requests app.js?v=590', /app\.js\?v=590/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 590', /__AURIX_APPJS_VERSION__ = '590';/.test(app));
