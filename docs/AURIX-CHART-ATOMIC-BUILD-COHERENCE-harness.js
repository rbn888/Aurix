...
ok('0 version.json.appjs = 588', versionJson.appjs === 588);
ok('0 index APPJS_V = 588', /var APPJS_V = '588';/.test(indexHtml));
ok('0 index requests app.js?v=588', /app\.js\?v=588/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 588', /__AURIX_APPJS_VERSION__ = '588';/.test(app));
