...
ok('0 version.json.appjs = 524', versionJson.appjs === 524);
ok('0 index APPJS_V = 524', /var APPJS_V = '524';/.test(indexHtml));
ok('0 index requests app.js?v=524', /app\.js\?v=524/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 524', /__AURIX_APPJS_VERSION__ = '524';/.test(app));
