...
ok('0 version.json.appjs = 586', versionJson.appjs === 586);
ok('0 index APPJS_V = 586', /var APPJS_V = '586';/.test(indexHtml));
ok('0 index requests app.js?v=586', /app\.js\?v=586/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 586', /__AURIX_APPJS_VERSION__ = '586';/.test(app));
