...
ok('0 version.json.appjs = 544', versionJson.appjs === 544);
ok('0 index APPJS_V = 544', /var APPJS_V = '544';/.test(indexHtml));
ok('0 index requests app.js?v=544', /app\.js\?v=544/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 544', /__AURIX_APPJS_VERSION__ = '544';/.test(app));
