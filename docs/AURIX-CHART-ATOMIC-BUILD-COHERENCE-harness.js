...
ok('0 version.json.appjs = 561', versionJson.appjs === 561);
ok('0 index APPJS_V = 561', /var APPJS_V = '561';/.test(indexHtml));
ok('0 index requests app.js?v=561', /app\.js\?v=561/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 561', /__AURIX_APPJS_VERSION__ = '561';/.test(app));
