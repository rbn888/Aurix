...
ok('0 version.json.appjs = 594', versionJson.appjs === 594);
ok('0 index APPJS_V = 594', /var APPJS_V = '594';/.test(indexHtml));
ok('0 index requests app.js?v=594', /app\.js\?v=594/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 594', /__AURIX_APPJS_VERSION__ = '594';/.test(app));
