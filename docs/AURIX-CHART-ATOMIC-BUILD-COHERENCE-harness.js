...
ok('0 version.json.appjs = 570', versionJson.appjs === 570);
ok('0 index APPJS_V = 570', /var APPJS_V = '570';/.test(indexHtml));
ok('0 index requests app.js?v=570', /app\.js\?v=570/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 570', /__AURIX_APPJS_VERSION__ = '570';/.test(app));
