...
ok('0 version.json.appjs = 566', versionJson.appjs === 566);
ok('0 index APPJS_V = 566', /var APPJS_V = '566';/.test(indexHtml));
ok('0 index requests app.js?v=566', /app\.js\?v=566/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 566', /__AURIX_APPJS_VERSION__ = '566';/.test(app));
