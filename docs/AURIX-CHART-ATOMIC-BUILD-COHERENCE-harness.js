...
ok('0 version.json.appjs = 534', versionJson.appjs === 534);
ok('0 index APPJS_V = 534', /var APPJS_V = '534';/.test(indexHtml));
ok('0 index requests app.js?v=534', /app\.js\?v=534/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 534', /__AURIX_APPJS_VERSION__ = '534';/.test(app));
