...
ok('0 version.json.appjs = 589', versionJson.appjs === 589);
ok('0 index APPJS_V = 589', /var APPJS_V = '589';/.test(indexHtml));
ok('0 index requests app.js?v=589', /app\.js\?v=589/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 589', /__AURIX_APPJS_VERSION__ = '589';/.test(app));
