...
ok('0 version.json.appjs = 541', versionJson.appjs === 541);
ok('0 index APPJS_V = 541', /var APPJS_V = '541';/.test(indexHtml));
ok('0 index requests app.js?v=541', /app\.js\?v=541/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 541', /__AURIX_APPJS_VERSION__ = '541';/.test(app));
