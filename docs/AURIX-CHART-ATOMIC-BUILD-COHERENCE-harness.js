...
ok('0 version.json.appjs = 540', versionJson.appjs === 540);
ok('0 index APPJS_V = 540', /var APPJS_V = '540';/.test(indexHtml));
ok('0 index requests app.js?v=540', /app\.js\?v=540/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 540', /__AURIX_APPJS_VERSION__ = '540';/.test(app));
