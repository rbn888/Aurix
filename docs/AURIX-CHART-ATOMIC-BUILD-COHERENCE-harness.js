...
ok('0 version.json.appjs = 597', versionJson.appjs === 597);
ok('0 index APPJS_V = 597', /var APPJS_V = '597';/.test(indexHtml));
ok('0 index requests app.js?v=597', /app\.js\?v=597/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 597', /__AURIX_APPJS_VERSION__ = '597';/.test(app));
