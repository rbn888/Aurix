...
ok('0 version.json.appjs = 592', versionJson.appjs === 592);
ok('0 index APPJS_V = 592', /var APPJS_V = '592';/.test(indexHtml));
ok('0 index requests app.js?v=592', /app\.js\?v=592/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 592', /__AURIX_APPJS_VERSION__ = '592';/.test(app));
