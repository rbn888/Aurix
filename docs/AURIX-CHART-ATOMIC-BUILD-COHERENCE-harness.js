...
ok('0 version.json.appjs = 533', versionJson.appjs === 533);
ok('0 index APPJS_V = 533', /var APPJS_V = '533';/.test(indexHtml));
ok('0 index requests app.js?v=533', /app\.js\?v=533/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 533', /__AURIX_APPJS_VERSION__ = '533';/.test(app));
