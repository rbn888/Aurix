...
ok('0 version.json.appjs = 569', versionJson.appjs === 569);
ok('0 index APPJS_V = 569', /var APPJS_V = '569';/.test(indexHtml));
ok('0 index requests app.js?v=569', /app\.js\?v=569/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 569', /__AURIX_APPJS_VERSION__ = '569';/.test(app));
