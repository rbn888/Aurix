...
ok('0 version.json.appjs = 547', versionJson.appjs === 547);
ok('0 index APPJS_V = 547', /var APPJS_V = '547';/.test(indexHtml));
ok('0 index requests app.js?v=547', /app\.js\?v=547/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 547', /__AURIX_APPJS_VERSION__ = '547';/.test(app));
