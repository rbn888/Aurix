...
ok('0 version.json.appjs = 537', versionJson.appjs === 537);
ok('0 index APPJS_V = 537', /var APPJS_V = '537';/.test(indexHtml));
ok('0 index requests app.js?v=537', /app\.js\?v=537/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 537', /__AURIX_APPJS_VERSION__ = '537';/.test(app));
