...
ok('0 version.json.appjs = 587', versionJson.appjs === 587);
ok('0 index APPJS_V = 587', /var APPJS_V = '587';/.test(indexHtml));
ok('0 index requests app.js?v=587', /app\.js\?v=587/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 587', /__AURIX_APPJS_VERSION__ = '587';/.test(app));
