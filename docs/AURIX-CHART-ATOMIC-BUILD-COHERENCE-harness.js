...
ok('0 version.json.appjs = 580', versionJson.appjs === 580);
ok('0 index APPJS_V = 580', /var APPJS_V = '580';/.test(indexHtml));
ok('0 index requests app.js?v=580', /app\.js\?v=580/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 580', /__AURIX_APPJS_VERSION__ = '580';/.test(app));
