...
ok('0 version.json.appjs = 543', versionJson.appjs === 543);
ok('0 index APPJS_V = 543', /var APPJS_V = '543';/.test(indexHtml));
ok('0 index requests app.js?v=543', /app\.js\?v=543/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 543', /__AURIX_APPJS_VERSION__ = '543';/.test(app));
