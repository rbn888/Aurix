...
ok('0 version.json.appjs = 599', versionJson.appjs === 599);
ok('0 index APPJS_V = 599', /var APPJS_V = '599';/.test(indexHtml));
ok('0 index requests app.js?v=599', /app\.js\?v=599/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 599', /__AURIX_APPJS_VERSION__ = '599';/.test(app));
