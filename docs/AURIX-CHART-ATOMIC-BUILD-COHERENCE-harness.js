...
ok('0 version.json.appjs = 557', versionJson.appjs === 557);
ok('0 index APPJS_V = 557', /var APPJS_V = '557';/.test(indexHtml));
ok('0 index requests app.js?v=557', /app\.js\?v=557/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 557', /__AURIX_APPJS_VERSION__ = '557';/.test(app));
