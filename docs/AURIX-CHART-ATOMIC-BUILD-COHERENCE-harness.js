...
ok('0 version.json.appjs = 600', versionJson.appjs === 600);
ok('0 index APPJS_V = 600', /var APPJS_V = '600';/.test(indexHtml));
ok('0 index requests app.js?v=600', /app\.js\?v=600/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 600', /__AURIX_APPJS_VERSION__ = '600';/.test(app));
