...
ok('0 version.json.appjs = 550', versionJson.appjs === 550);
ok('0 index APPJS_V = 550', /var APPJS_V = '550';/.test(indexHtml));
ok('0 index requests app.js?v=550', /app\.js\?v=550/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 550', /__AURIX_APPJS_VERSION__ = '550';/.test(app));
