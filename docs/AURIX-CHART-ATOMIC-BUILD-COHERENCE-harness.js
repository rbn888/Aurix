...
ok('0 version.json.appjs = 559', versionJson.appjs === 559);
ok('0 index APPJS_V = 559', /var APPJS_V = '559';/.test(indexHtml));
ok('0 index requests app.js?v=559', /app\.js\?v=559/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 559', /__AURIX_APPJS_VERSION__ = '559';/.test(app));
