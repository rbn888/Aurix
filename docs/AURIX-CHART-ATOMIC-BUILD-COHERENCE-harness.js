...
ok('0 version.json.appjs = 574', versionJson.appjs === 574);
ok('0 index APPJS_V = 574', /var APPJS_V = '574';/.test(indexHtml));
ok('0 index requests app.js?v=574', /app\.js\?v=574/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 574', /__AURIX_APPJS_VERSION__ = '574';/.test(app));
