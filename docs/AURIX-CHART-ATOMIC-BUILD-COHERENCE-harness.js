...
ok('0 version.json.appjs = 535', versionJson.appjs === 535);
ok('0 index APPJS_V = 535', /var APPJS_V = '535';/.test(indexHtml));
ok('0 index requests app.js?v=535', /app\.js\?v=535/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 535', /__AURIX_APPJS_VERSION__ = '535';/.test(app));
