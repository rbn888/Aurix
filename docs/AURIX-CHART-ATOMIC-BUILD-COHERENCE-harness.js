...
ok('0 version.json.appjs = 555', versionJson.appjs === 555);
ok('0 index APPJS_V = 555', /var APPJS_V = '555';/.test(indexHtml));
ok('0 index requests app.js?v=555', /app\.js\?v=555/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 555', /__AURIX_APPJS_VERSION__ = '555';/.test(app));
