...
ok('0 version.json.appjs = 565', versionJson.appjs === 565);
ok('0 index APPJS_V = 565', /var APPJS_V = '565';/.test(indexHtml));
ok('0 index requests app.js?v=565', /app\.js\?v=565/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 565', /__AURIX_APPJS_VERSION__ = '565';/.test(app));
