...
ok('0 version.json.appjs = 595', versionJson.appjs === 595);
ok('0 index APPJS_V = 595', /var APPJS_V = '595';/.test(indexHtml));
ok('0 index requests app.js?v=595', /app\.js\?v=595/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 595', /__AURIX_APPJS_VERSION__ = '595';/.test(app));
