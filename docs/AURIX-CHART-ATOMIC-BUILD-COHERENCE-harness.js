...
ok('0 version.json.appjs = 579', versionJson.appjs === 579);
ok('0 index APPJS_V = 579', /var APPJS_V = '579';/.test(indexHtml));
ok('0 index requests app.js?v=579', /app\.js\?v=579/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 579', /__AURIX_APPJS_VERSION__ = '579';/.test(app));
