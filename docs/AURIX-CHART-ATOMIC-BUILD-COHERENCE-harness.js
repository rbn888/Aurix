...
ok('0 version.json.appjs = 538', versionJson.appjs === 538);
ok('0 index APPJS_V = 538', /var APPJS_V = '538';/.test(indexHtml));
ok('0 index requests app.js?v=538', /app\.js\?v=538/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 538', /__AURIX_APPJS_VERSION__ = '538';/.test(app));
