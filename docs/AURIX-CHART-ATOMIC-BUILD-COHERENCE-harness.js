...
ok('0 version.json.appjs = 596', versionJson.appjs === 596);
ok('0 index APPJS_V = 596', /var APPJS_V = '596';/.test(indexHtml));
ok('0 index requests app.js?v=596', /app\.js\?v=596/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 596', /__AURIX_APPJS_VERSION__ = '596';/.test(app));
