...
ok('0 version.json.appjs = 526', versionJson.appjs === 526);
ok('0 index APPJS_V = 526', /var APPJS_V = '526';/.test(indexHtml));
ok('0 index requests app.js?v=526', /app\.js\?v=526/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 526', /__AURIX_APPJS_VERSION__ = '526';/.test(app));
