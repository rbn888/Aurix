...
ok('0 version.json.appjs = 525', versionJson.appjs === 525);
ok('0 index APPJS_V = 525', /var APPJS_V = '525';/.test(indexHtml));
ok('0 index requests app.js?v=525', /app\.js\?v=525/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 525', /__AURIX_APPJS_VERSION__ = '525';/.test(app));
