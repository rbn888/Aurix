...
ok('0 version.json.appjs = 536', versionJson.appjs === 536);
ok('0 index APPJS_V = 536', /var APPJS_V = '536';/.test(indexHtml));
ok('0 index requests app.js?v=536', /app\.js\?v=536/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 536', /__AURIX_APPJS_VERSION__ = '536';/.test(app));
