...
ok('0 version.json.appjs = 530', versionJson.appjs === 530);
ok('0 index APPJS_V = 530', /var APPJS_V = '530';/.test(indexHtml));
ok('0 index requests app.js?v=530', /app\.js\?v=530/.test(indexHtml));
ok('0 executed bundle self-version __AURIX_APPJS_VERSION__ = 530', /__AURIX_APPJS_VERSION__ = '530';/.test(app));
