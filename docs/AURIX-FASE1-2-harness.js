...
// FASE 2 write-guard moved to docs/AURIX-SNAPSHOT-WRITE-GUARD-harness.js (_shouldRejectSnapshot).
...
console.log('\n(FASE 2 write-guard validated in docs/AURIX-SNAPSHOT-WRITE-GUARD-harness.js)');
