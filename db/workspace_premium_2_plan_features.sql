...
--
-- Idempotente y ADITIVO: DOCE filas en `public.plan_features`. No toca el esquema,
...
--   Las seis capacidades del catálogo canónico ya declaran su `featureKey` en
...
--   3. poner `published: true` en las seis entradas de `_WS_CATALOG` — una línea
...
insert into public.plan_features (plan, feature_key, allowed) values
  ...
  -- Seguimiento de precios · PLANTILLA
  ('free',    'workspace.prices',      false),
  ('premium', 'workspace.prices',      true),
  -- Objetivos · PLANTILLA
...
-- -- esperado: 12 filas · premium=true · free=false
--
